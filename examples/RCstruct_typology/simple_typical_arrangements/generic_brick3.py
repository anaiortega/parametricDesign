...
botLnRb={'id':'2','fi':16e-3,'s':0.20,'distRFstart':0.1,'distRFend':0.5,'extrShapeStart':'anc0_posPoor_compr','position':'good','vectorLRef':Vector(0.20,-0.3)}
# bottom longitudinal rebars data
topTrnsRb={'id':'3','fi':20e-3,'s':0.15,'distRFstart':0.2,'distRFend':0.1,'extrShapeEnd':'anc90_posPoor_compr','position':'poor','vectorLRef':Vector(-0.1,0.35)}
...
stirrHoldTr={'id':'5' ,'fi':8e-3 ,'sRealSh':0.30 ,'sPerp':0.15 ,'nStirrRealSh': 3 , 'nStirrPerp':4 ,'widthStirr': 0.25, 'dispRealSh': -0.4, 'dispPerp':-0.1,'vectorLRef':Vector(0.3,-0.5),'rightSideLabelLn':True}

# stirrups holding longitudinal rebars
stirrHoldLn={'id':'6' ,'fi':10e-3 ,'sRealSh':0.20 ,'sPerp':0.30 ,'nStirrRealSh': 5 , 'nStirrPerp':2 ,'widthStirr': 0.40, 'dispRealSh': -1.5, 'dispPerp':-1.3,'vectorLRef':Vector(0.2,-0.5),'rightSideLabelLn':True}
