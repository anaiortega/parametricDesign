...
width=8 #dimension of the slab in the direction of the transversal rebars
length=11 #dimension of the slab in the direction of the longitudinal rebars
thickness=0.4  #thickness of the slab
# bottom transverse rebars data
botTrnsRb={'id':'1','fi':20e-3,'s':0.15,'distRFstart':0.0,'distRFend':0,'gapStart':0,'extrShapeStart':'anc0_posPoor_compr','position':'good','vectorLRef':Vector(0.3,-0.2)}#,'fixLengthEnd':5} 
# top transverse rebars data
botLnRb={'id':'2','fi':16e-3,'s':0.20,'distRFstart':0.0,'distRFend':0.0,'extrShapeStart':None,'position':'good','vectorLRef':Vector(0.1,-0.3)}
# bottom longitudinal rebars data
topTrnsRb={'id':'3','fi':20e-3,'s':0.15,'distRFstart':0.0,'distRFend':0.0,'extrShapeEnd':'anc90_posPoor_compr','position':'poor','vectorLRef':Vector(-0.3,0.15)}
# top longitudinal rebars data
topLnRb={'id':'4','fi':16e-3,'s':0.20,'distRFstart':0.0,'distRFend':0.0,'extrShapeEnd':None,'position':'poor','vectorLRef':Vector(-0.2,0.3)}
...
lstRebarFam,lstStirrupFam=trcm.sloped_edge_brick_reinf(width=width,length=length,thickness=thickness,anchPtTrnsSect=anchPtTrnsSect,anchPtLnSect=anchPtLnSect,reinfCfg=reinfCfg,slopeYmaxEdge=-1/1,angTrns=0,angLn=90,botTrnsRb=botTrnsRb,topTrnsRb=topTrnsRb,botLnRb=botLnRb,topLnRb=topLnRb,drawConcrTrSect=True,drawConcrLnSect=True)
