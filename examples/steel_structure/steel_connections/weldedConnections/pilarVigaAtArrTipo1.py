...
docName='pilar_vatado_arr_tipo1'
...
hOrigenArr=50                 #distancia vertical entre el lado horizontal de la cartela y el punto de
...
ang1=40                        #ángulo entre el eje de la diagonal y el lado de la cartela contiguo a su lado vertical
ang2=20                        #ángulo entre el eje de la diagonal y el lado de la cartela contiguo a su lado horizontal
VPteArr=4.5                    #VPteArr y HPteArr definen la pendiente de la diagonal
HPteArr=4
