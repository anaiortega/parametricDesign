...
from freeCADcivilOrt import geometry_3D
from freeCADcivilOrt import metallic_profiles
from freeCADcivilOrt import metallic_struct
...
idPerfilCorrea='220'
cantoCorrea=metallic_profiles.IPN[idPerfilCorrea]['h']
...
incrFin=extensVCarr
giroSec=0
vigaCarrI=metallic_struct.barra2Ptos(ptoIni,ptoFin,perfil,tamPerfil,incrIni,incrFin,giroSec)
#Part.show(vigaCarr)
#Rigidizadores viga carrilera
...
incrFin=extensVCarr
giroSec=0
vigaCarrD=metallic_struct.barra2Ptos(ptoIni,ptoFin,perfil,tamPerfil,incrIni,incrFin,giroSec)
#Rigidizadores viga carrilera
vOrigenL=Base.Vector(-eRigVCarr/2,distYejesVCarr/2,dimZPilar)
vDirXL=Base.Vector(0,1,0)
vDirYL=Base.Vector(0,0,1)
