...
signoRigPosNeg='Neg'
vat=Metalicas.VatSoldAlmPilarCart(vectorDir,anchoPerfilPilar,eAlmaPerfilPilar,holgAlaPilarVAtado,LVAtado,tipoPerfilVAtado,idPerfilVAtado,eAlmaPerfilVAtado,solapeRigAlmaV,hRig,espesorRig,hAcuerdRig,signoRigPosNeg)
