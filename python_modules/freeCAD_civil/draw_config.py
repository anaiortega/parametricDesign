...
colorTextRight=(0.8,0.80,0.80) # ligth gray (color 254 Autocad) 
colorFrames=(0.50,0.00,0.50) #purple (color 214 Autocad)
...
defaultReinfConf=reinfConf(cover=0.03,xcConcr=EC2_materials.C25,xcSteel=EC2_materials.S500C)
