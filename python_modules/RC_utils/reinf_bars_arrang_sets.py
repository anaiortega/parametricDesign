...
def anchor_length_EHE(concrType,steelType,fi,position,anchType,stressState='compr',ratAs=1.0,dynamEff=False):
    ...
    :param dynamEff: =True if dynamic effects may occur, False otherwise.
           Defaults to  False
    '''
